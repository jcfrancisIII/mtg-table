        ...
        players.forEach((thisPlayer, i, arr) => {
            ...
            turns.forEach((turn, i) => {
                for (let affectedPlayerNumber in turn.damageData) {
                    ...
                    let affectingPlayer =
                        affectedPlayer.lifeEffect[thisPlayerNumber]
                    thisPlayer.dmgTo[affectedPlayerNumber].healing +=
                        affectingPlayer.healing
                    thisPlayer.dmgTo[affectedPlayerNumber].damage +=
                        affectingPlayer.damage

                    thisPlayer.healing += affectingPlayer.healing
                    thisPlayer.damage += affectingPlayer.damage
                    thisPlayer.kills = affectingPlayer.kill
                        ? thisPlayer.kills + 1
                        : thisPlayer.kills
                }
            })
